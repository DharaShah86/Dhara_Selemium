 ...
 * @author shahs
 */
public class VerifyAvailableHeadphonePageTest {
    
    public VerifyAvailableHeadphonePageTest() {
    }
    ...
    //
    @Test
     public void testVerifyAvailableHeadphone() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='slider']/div")).click();
    driver.findElement(By.xpath("//div[@id='slider']/div/div")).click();
    driver.findElement(By.xpath("//div[@id='mobileSlide']/ul/li/div")).click();
    driver.findElement(By.xpath("//div[@id='slider']/div/div[2]")).click();
    ...
    driver.findElement(By.id("compatibility_2")).click();
    driver.findElement(By.xpath("//div[@id='mobileSlide']/ul/li[2]/div/div/div/label")).click();
    driver.findElement(By.id("compatibility_0")).click();
    driver.findElement(By.id("accordionAttrib0")).click();
    driver.findElement(By.id("accordionAttrib0")).click();
    driver.findElement(By.id("compatibility_1")).click();
    ...
    driver.findElement(By.id("connector_1")).click();
    driver.findElement(By.id("connector_1")).click();
    driver.findElement(By.id("connector_0")).click();
    driver.findElement(By.id("connector_1")).click();
    driver.findElement(By.id("connector_0")).click();
    driver.findElement(By.id("connector_1")).click();
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='HEADPHONES'])[2]/following::div[4]")).click();
    driver.findElement(By.id("weight_1")).click();
    driver.findElement(By.id("accordionAttrib2")).click();
